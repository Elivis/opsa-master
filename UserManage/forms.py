...
class AddUserForm(forms.ModelForm):
    class Meta:
        model = User
        fields = ('username','password','email','nickname','mobile','role','is_active')
        widgets = {
    ...
    def __init__(self,*args,**kwargs):
        ...
        self.fields['mobile'].label=u'手机号'
        self.fields['mobile'].error_messages={'required':u'请输入手机号'}
...
class EditUserForm(forms.ModelForm):
    class Meta:
        model = User
        fields = ('username','email','nickname','mobile','role','is_active')
        widgets = {
            'username' : forms.TextInput(attrs={'class':'form-control'}),
...
class ProfileUserForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'nickname' : forms.TextInput(attrs={'class':'form-control'}),
            'mobile' : forms.TextInput(attrs={'class':'form-control'}),
            'role' : forms.Select(choices=[(x.name,x.name) for x in RoleList.objects.all()],attrs={'class':'form-control','disabled':'disabled'}),
            'is_active' : forms.Select(choices=((True, u'启用'),(False, u'禁用')),attrs={'class':'form-control','disabled':'disabled'}),
        }
    def __init__(self,*args,**kwargs):
        ...
        self.fields['nickname'].label=u'姓 名'
        self.fields['nickname'].error_messages={'required':u'请输入姓名'}
        self.fields['mobile'].label=u'手 机'
        self.fields['mobile'].error_messages={'required':u'请输入手机号'}
        self.fields['role'].label=u'角 色'
        self.fields['is_active'].label=u'状 态'
