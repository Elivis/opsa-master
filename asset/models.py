...
class HostList(models.Model):
    ...
    version = models.CharField(max_length=60, verbose_name=u'产品')
    application = models.CharField(max_length=20, verbose_name=u'应用')
    #application = models.ManyToManyField(Hostgroups,null=True,blank=True)
    ...
    mem = models.CharField(max_length=10, verbose_name='内存大小')
    os_ver = models.CharField(max_length=50, verbose_name=u'操作系统版本')
    ...
    add_date = models.DateTimeField(auto_now_add=True, verbose_name=u'时间')
...
class Hostgroups(models.Model):
    ...
    hostlist = models.ManyToManyField(HostList,null=True,blank=True)
